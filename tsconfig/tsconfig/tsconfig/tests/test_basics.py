...
"""
    ...
    # This tests the behaviour when the platform..info is missing
    @mock.patch('logging.exception')
    @mock.patch('six.moves.builtins.open')
    @mock.patch('os.path.isfile', return_value=True)
    ...
    # This tests the behaviour when the platform.info is empty
    @mock.patch('logging.exception')
    @mock.patch('six.moves.builtins.open')
    @mock.patch('os.path.isfile', return_value=True)
    ...
    # This tests the behaviour when the platform.info has the minimal entries
    @mock.patch('six.moves.builtins.open')
    @mock.patch('os.path.isfile', return_value=True)
